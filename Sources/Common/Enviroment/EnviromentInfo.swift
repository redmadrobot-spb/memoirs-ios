...
struct EnviromentInfo {
    ...
    static var current: EnviromentInfo {
        ...
        return EnviromentInfo(
            appId: infoPlist?["CFBundleIdentifier"] as? String,
            ...
            deviceModel: EnviromentInfo.displayDeviceName(for: identifier)
        )
    }
