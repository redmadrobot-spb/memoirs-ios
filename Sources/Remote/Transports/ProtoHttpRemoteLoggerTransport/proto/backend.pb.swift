...
struct JournalTokenResponse {
  ...
  var liveConnectionCode: String {
    get {return _liveConnectionCode ?? String()}
    set {_liveConnectionCode = newValue}
  }
  /// Returns true if `liveConnectionCode` has been explicitly set.
  var hasLiveConnectionCode: Bool {return self._liveConnectionCode != nil}
  /// Clears the value of `liveConnectionCode`. Subsequent reads from it will return its default value.
  mutating func clearLiveConnectionCode() {self._liveConnectionCode = nil}
  ...
  fileprivate var _liveConnectionCode: String? = nil
}
...
extension JournalTokenResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    2: .standard(proto: "live_connection_code"),
  ]

  public var isInitialized: Bool {
    if self._journalToken == nil {return false}
    if self._liveConnectionCode == nil {return false}
    return true
  }
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try decoder.decodeSingularStringField(value: &self._liveConnectionCode)
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if let v = self._liveConnectionCode {
  ...
  static func ==(lhs: JournalTokenResponse, rhs: JournalTokenResponse) -> Bool {
    ...
    if lhs._liveConnectionCode != rhs._liveConnectionCode {return false}
