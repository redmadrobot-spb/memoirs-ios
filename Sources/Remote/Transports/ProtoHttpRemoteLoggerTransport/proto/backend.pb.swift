...
// Source: Sources/Remote/Transports/ProtoHttpRemoteLoggerTransport/proto/backend.proto
//
...
struct SenderTokenRequest {
  ...
  var sender: SenderTokenRequest.Sender {
    get {return _sender ?? SenderTokenRequest.Sender()}
  ...
  fileprivate var _sender: SenderTokenRequest.Sender? = nil
}

struct SenderTokenResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var senderToken: String {
    get {return _senderToken ?? String()}
    set {_senderToken = newValue}
  }
  /// Returns true if `senderToken` has been explicitly set.
  var hasSenderToken: Bool {return self._senderToken != nil}
  /// Clears the value of `senderToken`. Subsequent reads from it will return its default value.
  mutating func clearSenderToken() {self._senderToken = nil}

  var unknownFields = SwiftProtobuf.UnknownStorage()

  init() {}

  fileprivate var _senderToken: String? = nil
}
...
extension SenderTokenRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = "SenderTokenRequest"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "secret"),
    2: .same(proto: "sender"),
  ]
  ...
  static func ==(lhs: SenderTokenRequest, rhs: SenderTokenRequest) -> Bool {
...
extension SenderTokenRequest.Sender: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = SenderTokenRequest.protoMessageName + ".Sender"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "id"),
  ...
  static func ==(lhs: SenderTokenRequest.Sender, rhs: SenderTokenRequest.Sender) -> Bool {
...
extension SenderTokenResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = "SenderTokenResponse"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .standard(proto: "sender_token"),
  ]

  public var isInitialized: Bool {
    if self._senderToken == nil {return false}
    return true
  }
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeSingularStringField(value: &self._senderToken)
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    if let v = self._senderToken {
      try visitor.visitSingularStringField(value: v, fieldNumber: 1)
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  static func ==(lhs: SenderTokenResponse, rhs: SenderTokenResponse) -> Bool {
    if lhs._senderToken != rhs._senderToken {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
