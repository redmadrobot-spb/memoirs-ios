...
// Source: Sources.Robologs.Remote/Transports/ProtoHttpRemoteLoggerTransport/proto/backend.proto
//
...
extension AuthRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularStringField(value: &self._secret) }()
...
extension AuthRequest.Sender: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 4: try { try decoder.decodeSingularStringField(value: &self._appVersion) }()
      case 5: try { try decoder.decodeSingularStringField(value: &self._appBuildVersion) }()
      case 6: try { try decoder.decodeSingularStringField(value: &self._operationSystem) }()
      case 7: try { try decoder.decodeSingularStringField(value: &self._operationSystemVersion) }()
      case 8: try { try decoder.decodeSingularStringField(value: &self._deviceModel) }()
      default: break
      }
    }
  }
...
extension LogMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularUInt64Field(value: &self._position) }()
      case 2: try { try decoder.decodeSingularUInt64Field(value: &self._timestampMillis) }()
      case 3: try { try decoder.decodeSingularEnumField(value: &self._priority) }()
